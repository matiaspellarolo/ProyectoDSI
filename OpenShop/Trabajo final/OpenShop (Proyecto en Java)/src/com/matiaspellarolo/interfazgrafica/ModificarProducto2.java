...
public class ModificarProducto2 extends JPanel
{
	...
	public ModificarProducto2(GestorCategorias gestorCategorias, GestorTiposProductos gestorTiposProductos, GestorProductos gestorProductos)
	{
        ...
        int idCategoria = gestorTiposProductos.buscarIdCategoria(producto.getIdTipoProducto());
        ...
        String nombreTipoProducto = gestorTiposProductos.buscarNombreTipoCategoria(producto.getIdTipoProducto());
	...
	public void modificarProducto(GestorTiposProductos gestorTiposProductos, GestorProductos gestorProductos)
	{
		try {
			...
			int idTipoProducto = tipoProductoSeleccionado(gestorTiposProductos);
	        ...
	        gestorProductos.modificarProducto(Programa.id, id, nombre, marca, precio, stock, descripcion, idTipoProducto, nombreTipoProducto, nombreCategoria);
	        listo = true;
			}catch(Exception e) {
	...
	public int idIngresado(GestorProductos gestorProductos) throws Exception
	{
		...
		else if(gestorProductos.buscarProducto(Integer.parseInt(textFieldId.getText())) != null && Integer.parseInt(textFieldId.getText()) != idActual)
		{
	...
	public int tipoProductoSeleccionado(GestorTiposProductos gestorTiposProductos) throws Exception
	{
